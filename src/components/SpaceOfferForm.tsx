...
export default function SpaceOfferForm() {
  ...
  const [formData, setFormData] = useState<SpaceOfferFormData>({
    pnr: '',
    name: '',
    email: '',
    phone: '',
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage('Space offer submitted successfully!');
      setFormData({
        pnr: '',
